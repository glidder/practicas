...
\frame{
    ...
    For the {\bf NP} class there's a {\bf coNP} class which, for every decision problem {\it P} in {\bf NP}, contains the complemental decision problem, denoted {\it coP}; that is, the decision problem in which the “Yes” instances are “No” instances of {\bf P} and vice versa.
    \end{exampleblock}
