...
(defglobal ?*afir* = (create$ "Es bueno ser positivo" "Me gusta la positividad" "Me gustan las personas optimistas"))
...
(deffunction  analisis1 (?cadena)
	...
	(if (str-index "hacer deporte" ?cadena)
	then (assert (frase buenoshabitos ?cadena)))	
