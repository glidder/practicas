...
sentencia	: sentencia bloque 					{ cout<<"sentencia --> sentencia bloque"<<endl;}
			| sentencia tipo corcho ID declaracion 	{ cout<<"sentencia --> sentencia tipo corcho ID (" << *$4 << ") declaracion"<<endl;delete $4;}
 			| sentencia WHILE '(' asignacion ')' bloque { cout<<"sentencia --> sentencia while '(' asignacion ')' bloque"<<endl;}
			| sentencia IF '(' asignacion ')' bloque else  { cout<<"sentencia -->  sentencia if '(' asignacion ')' bloque else"<<endl;}
			| sentencia RETURN   				{ cout<<" sentencia --> sentencia return asignacion "<<endl;}
...
;
else		: ELSE bloque            			{ cout << "else --> else bloque" << endl; }
...
producto	: basico            				{ cout << "producto --> basico" << endl; }
			...
			| producto '/' basico        		{ cout << "producto --> producto '/' basico" << endl; }
;
basico		: ID ident                			{ cout << "basico --> ID (" << *$1 << ") ident" << endl; delete $1;}
