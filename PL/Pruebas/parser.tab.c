...
#line 1342 "parser.tab.c" /* yacc.c:1646  */
  ...
  case 7:
#line 41 "parser.y" /* yacc.c:1646  */
    {(yyval.nodo) = new NodoFuncion((yyvsp[0].nodo),*(yyvsp[-6].nombre),to_string(ambitos.nfun-1),ambitos.npar); ambitos.cerrarAmbito();}
...
#line 74 "parser.y" /* yacc.c:1646  */
    {(yyval.nodo)= new NodoParametro((yyvsp[-1].nodo),(yyvsp[0].nodo));}
...
#line 77 "parser.y" /* yacc.c:1646  */
    {(yyval.nodo)= new NodoParametro((yyvsp[-2].nodo),(yyvsp[0].nodo));}
