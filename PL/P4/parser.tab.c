...
{
       0,    29,    29,    29,    31,    32,    34,    34,    36,    37,
      38,    38,    40,    40,    41,    43,    43,    45,    45,    46,
      48,    48,    50,    50,    51
};
#endif
...
{
  "$end", "error", "$undefined", "INT", "CHAR", "STRUCT", "NUM", "ID",
  "';'", "'{'", "'}'", "','", "'*'", "'['", "']'", "$accept", "Ini", "$@1",
  "Ld", "Def", "@2", "Tipo", "$@3", "LVar", "@4", "Var", "@5", "Lpnt",
  "@6", "VFin", "@7", "Tablas", "@8", YY_NULLPTR
};
#endif
...
{
     -16,     4,   -16,   -16,     5,   -16,   -16,    -2,   -16,   -16,
       2,     0,   -16,   -16,    -5,   -16,   -16,   -16,     0,   -16,
     -16,     6,    -3,   -16,     0,   -16,   -16,   -16,   -16,     1,
       9,   -16,     3,   -16,     1,   -16
};
...
{
       2,     0,     5,     1,     3,     8,     9,     0,     4,     6,
       0,    19,    10,    17,     0,    14,    15,     5,    19,     7,
      12,     0,     0,    18,    19,    20,    16,    11,    13,    24,
       0,    21,     0,    22,    24,    23
};
...
static const yytype_int8 yypgoto[] =
{
     -16,   -16,   -16,    -1,   -16,   -16,   -16,   -16,   -16,   -16,
      -6,   -16,     7,   -16,   -16,   -16,   -15,   -16
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     1,     2,     4,     8,    11,     9,    17,    14,    24,
      15,    21,    16,    18,    26,    29,    31,    34
};
...
{
       5,     6,     7,    19,     3,    10,    20,    27,     5,     6,
       7,    12,    13,    25,    30,    32,    22,    33,    28,    35,
       0,     0,     0,     0,     0,    23
};

static const yytype_int8 yycheck[] =
{
       3,     4,     5,     8,     0,     7,    11,    10,     3,     4,
       5,     9,    12,     7,    13,     6,    17,    14,    24,    34,
      -1,    -1,    -1,    -1,    -1,    18
};
...
{
       0,    16,    17,     0,    18,     3,     4,     5,    19,    21,
       7,    20,     9,    12,    23,    25,    27,    22,    28,     8,
      11,    26,    18,    27,    24,     7,    29,    10,    25,    30,
      13,    31,     6,    14,    32,    31
};
...
#line 29 "parser.y" /* yacc.c:1646  */
    { pila.push(new TablaSimbolos()); }
#line 1241 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 3:
#line 29 "parser.y" /* yacc.c:1646  */
    { pila.top()->escribir(); pila.pop(); }
...
#line 36 "parser.y" /* yacc.c:1646  */
    { (yyval.nodo) = new NodoInt(); }
#line 1271 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 9:
#line 37 "parser.y" /* yacc.c:1646  */
    { (yyval.nodo) = new NodoChar(); }
...
#line 1283 "parser.tab.c" /* yacc.c:1646  */
  ...
  case 11:
#line 38 "parser.y" /* yacc.c:1646  */
    { (yyval.nodo) = new NodoStruct((yyvsp[-4].nombre), pila.top()); pila.pop(); }
...
#line 45 "parser.y" /* yacc.c:1646  */
    { (yyval.nodo) = new NodoPunt((yyvsp[-1].nodo)); }
...
#line 1325 "parser.tab.c" /* yacc.c:1646  */
  ...
  case 21:
#line 48 "parser.y" /* yacc.c:1646  */
    { pila.top()->apunta_en_tabla((yyvsp[-2].nombre), (yyvsp[0].nodo)); }
...
#line 1337 "parser.tab.c" /* yacc.c:1646  */
  ...
  case 23:
#line 50 "parser.y" /* yacc.c:1646  */
    { (yyval.nodo) = new NodoArray((yyvsp[-3].valor), (yyvsp[0].nodo));}
